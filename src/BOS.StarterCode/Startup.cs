...
namespace BOS.StarterCode
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Context>(options => options.UseNpgsql(Configuration.GetConnectionString("StarterCode-PostgresDB")));
            ...
            services.AddTransient<EmailHelper>(e => new EmailHelper(Configuration["SendGrid:From"], Configuration["SendGrid:ApiKey"]));
